        ...
        <div className='fixed bottom-0 right-0 left-0 backdrop-blur-lg'>
            <div className='max-w-screen-md mx-auto'>
                ...
                <div className='w-full flex flex-row justify-center items-center'>
                    <p className='text-xs text-slate-500/80 line-clamp-2 '>
                        <Link target='_blank' href='https://github.com/iranzithierry' className='text-center underline-offset-2' underline={true} icon={true}>
                            Built by IRANZI Dev deploy your own.
                        </Link>
                    </p>
                </div>
            </div>
